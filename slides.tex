...
\begin{frame}{Lien avec notre projet}
  ...
  \footnotetext{On parle ici d'\oe{}uvre au sens général du terme, c'est-à-dire un objet physique ou virtuel résultant d'un travail humain.}
\end{frame}
...
\begin{frame}{LinuxSampler et QSampler}
  \begin{columns}
  \begin{column}{0.15\textwidth}
    \includegraphics[width=\linewidth]{linuxsampler_logo}
  \end{column}
  \begin{column}{0.85\textwidth}
